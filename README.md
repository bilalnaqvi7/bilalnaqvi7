...
<p align="left">
  <img src="https://img.shields.io/badge/Retention%20Marketing-111827?style=for-the-badge" />
...
- 💡 Data-driven marketer with product management experience and deep roots in **analytics, experimentation, and growth systems**
- 🔍 Experienced in **product discovery, market & competitive analysis, GTM strategy, and funnel design** across B2B2C platforms
- 📊 Hands-on with **data preparation, cohort & funnel analysis, attribution, and insight-driven storytelling**
- 🤖 Building **AI-driven automations, agentic workflows, and API-based systems** to scale execution and reduce operational overhead
- 🔁 Strong focus on **Customer Lifecycle Management (CLM)** — activation, retention, reactivation, and monetisation
- 🧪 Led **UATs, A/B tests, and experimentation frameworks** to ship scalable, compliant, and user-first solutions
- 🏛 Experience across **fintech, creator commerce, e-commerce, affiliate platforms, and consulting-style problem solving**
- 🌍 Collaborated with cross-functional teams across **India, MENA, SEA**, and academic–industry ecosystems

---
## 🧠 Core Skill Areas

- **Product Management:** 0→1 Strategy, PRDs, Roadmaps, Feature Design, UAT, GTM
- **Analytics & Data:** LTV/CAC, Cohort Analysis, Funnel Diagnostics, Attribution
- **Growth & Marketing:** Segmentation, Retention, Remarketing, CRM, Campaign Analytics
- **AI & Automation:** GenAI Workflows, Prompt Engineering, Agentic Systems, APIs
- **UX & CX:** User Journeys, Wireframing, NPS/CSAT, Conversion Optimisation
- **Consulting Mindset:** Structured problem-solving, unit economics, decks & stakeholder storytelling
